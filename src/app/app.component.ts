        ...
        <section class="tab-panel" *ngIf="activeTab === 'cooldown'">
          ...
          <div class="help-card" *ngIf="isHelpOpen('cooldown')">
            ...
            <ol>
              ...
              <li>輸入「活動持續時間」，例如 14:00～17:00 就填 3 小時。</li>
        ...
        <section class="tab-panel" *ngIf="activeTab === 'schedule'">
          ...
          <div class="help-card" *ngIf="isHelpOpen('schedule')">
            ...
            <ol>
              ...
              <li>輸入活動持續時間，例如下午 14:00 到下午 17:00，請填 3 小時。</li>
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  private readonly eventLocations: EventLocation[] = [
    ...
    { flag: '🇯🇵', country: '日本', city: '東京', place: '讀賣樂園 / PokéPark KANTO', lat: 35.625908, lon: 139.520940, timeZone: 'Asia/Tokyo', startDayOffset: 0, startTime: '13:00', searchKeys: 'japan tokyo yomiuriland poképark kanto pokepark kanto 日本 東京 讀賣樂園 寶可夢樂園 poképark kanto' },    
    ...
    { flag: '🇸🇦', country: '沙烏地阿拉伯', city: '利雅德', place: '利雅德公園購物中心', lat: 24.75695, lon: 46.62942, timeZone: 'Asia/Riyadh', startDayOffset: 0, startTime: '19:00', searchKeys: 'saudi arabia riyadh raid 沙烏地阿拉伯 利雅德 阿拉伯 利雅德公園購物中心' },    
  ...
  private readonly generalCities: CityData[] = [
    ...
    { name: '日本 讀賣樂園 / PokéPark KANTO (Yomiuriland)', utcOffset: 9.0, isReference: false, searchKeys: 'japan tokyo yomiuriland poképark kanto pokepark 日本 東京 讀賣樂園 寶可夢樂園', distanceKm: 2120 },
    ...
    { name: '沙烏地阿拉伯 利雅德 (Riyadh)', utcOffset: 3.0, isReference: false, searchKeys: 'saudi arabia riyadh 沙烏地阿拉伯 利雅德 阿拉伯', distanceKm: 7420 },
